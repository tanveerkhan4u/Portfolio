...
const Banner = () => {
  ...
  return (
    <div  className="lg:px-56 px-10 lg:py-0 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-28 items-center ">
        ...
        <div className="flex mt-8 gap-2 ">
          <div className="flex items-center justify-center ">
            <div className="flex space-x-2 ">
              <a href="https://github.com/tanveerkhan4u" className="text-fuchsia-600 hover:text-fuchsia-500 rounded-full glow p-2">
              <AiFillGithub  className="text-[28px]"/>
          
              </a>
              <a href="https://www.linkedin.com/in/mohd-tanveer-khan-b05a63243/" className="text-fuchsia-600 hover:text-fuchsia-500 rounded-full glow p-2">
      ...
      <img data-aos="fade-up" src={pic} width={290} height={290} className="rounded-full border-2 p-1 border-fuchsia-500 pic_glow" alt="" />
    </div>
  )
}
