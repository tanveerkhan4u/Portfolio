  ...
  return (
    <div id="About" className="">
      ...
      <div  className="h-full lg:py-40 flex flex-col justify-center lg:items-start items-center text-white ">
        ...
        <p data-aos="fade-left"> Lorem ipsum  sit amet consectetur adipisicing elit. Non eveniet accusamus quis ipsum eum debitis repellat ducimus, explicabo sunt tempore, natus enim ad accusantium, minus aperiam corporis commodi optio saepe!</p>
